...
#creating dataframe of cleaned heart.csv
df= ht.pd.read_csv('cleaned_heart.csv')

#giving title
st.title('Heart Disease Predictor')

#adding navigation bar
choice= st.sidebar.radio("",['About','Data','Data Visualization','Predict','Other info'])
...
if choice=='About':
    ...
    #creating dataframe
    data= ht.pd.read_csv('heart.csv')
    st.table(data)

elif choice == "Data Visualization":
    fig= ht.sn.heatmap(data= ht.heart)
    #st.pyplot(fig)
    ...
    pain= st.radio("Chest Pain Type",['ATA','NAP','ASY'])
    ecg= st.radio("Resting ECG",['Normal','LVH','ST'])
    ...
    if pain == 'ATA': pain= [1,0,0]
    elif pain == 'NAP': pain= [0,1,0]
    else: pain= [0,0,1]
